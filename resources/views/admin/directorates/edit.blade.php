...
<form action="{{URL::to('/admin/directorate/edit/'.$entity->id) }}" method="post" enctype="multipart/form-data" >
    {{ csrf_field() }}
    ...
    <div class="card-body" id="english-form">
     ...
     <div class="card-body" id="arabic-form">
        <img src="{{asset('images/directorate/'.$entity->image)}}" style="width:80px;height:80px;">
    </div>
