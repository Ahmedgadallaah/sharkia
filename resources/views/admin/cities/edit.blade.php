...
<form action="{{URL::to('/admin/city/edit/'.$entity->id) }}" method="post" enctype="multipart/form-data" >
    {{ csrf_field() }}
    ...
    <div class="card-body" id="english-form">
     ...
     <div class="card-body" id="arabic-form">
        <img src="{{asset('images/city/'.$entity->image)}}" style="width:80px;height:80px;">
    </div>
