    ...
    {{ csrf_field() }}
     ...
     <div class="card-body" id="arabic-form">
        <div class="form-group">
            ...
            <input class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" type="text" name="link" id="link" value="{{$social->link }}" required>
            @if($errors->has('link'))
     ...
     <div class="card-body" id="arabic-form">
        <img src="{{asset('images/social/'.$social->image)}}" style="width:80px;height:80px;">
    </div>
