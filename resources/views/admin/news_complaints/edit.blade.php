...
<form action="{{URL::to('/admin/news_complaint/edit/'.$news->id) }}" method="post" enctype="multipart/form-data" >
    {{ csrf_field() }}
    ...
    <div class="box box-info">
     ...
     <div class="card-body" id="arabic-form">
        <img src="{{asset('images/news_complaint/'.$news->image)}}" style="width:80px;height:80px;">
    </div>
