...
<div class="card-body" id="english-form">
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('en_name1') ? 'is-invalid' : '' }}" type="text" name="en_name1" id="en_name1" value="{{ old('en_name', '') }}" required>
 ...
 <div class="card-body" id="arabic-form">
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('ar_name1') ? 'is-invalid' : '' }}" type="text" name="ar_name1" id="ar_name1" value="{{ old('ar_name', '') }}" required>
 ...
 <div class="card-body" id="english-form">
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('en_name2') ? 'is-invalid' : '' }}" type="text" name="en_name2" id="en_name2" value="{{ old('en_name', '') }}" required>
 ...
 <div class="card-body" id="arabic-form">
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('ar_name2') ? 'is-invalid' : '' }}" type="text" name="ar_name2" id="ar_name2" value="{{ old('ar_name', '') }}" required>
 ...
 <div class="card-body" id="english-form">
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('en_name3') ? 'is-invalid' : '' }}" type="text" name="en_name3" id="en_name3" value="{{ old('en_name', '') }}" required>
 ...
 <div class="card-body" id="arabic-form">
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('ar_name3') ? 'is-invalid' : '' }}" type="text" name="ar_name3" id="ar_name3" value="{{ old('ar_name', '') }}" required>
